# CAMD Resource Guide
This resource guide exists to support the EPA's Clean Air Markets Divison (CAMD) product team as it works with an Agile vendor to improve how the CAMD manages its emission data. 
