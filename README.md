# CAMD Resource Guide
This resource guide exists to support the EPA's Clean Air Markets Division (CAMD) product team as it works with their vendor to improve how the CAMD collects and publishes power plant emissions data. 
